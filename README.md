...
### Product: Diverg Open vs private

| Tier | What it is |
|------|------------|
| **Diverg Open** | Self-serve security testing: browser extension (in-browser scans), web console, and API where we offer them, for authorized assessments. |
| **Private** | Professional investigations and deep security analysis using Diverg’s internal tooling and pipelines, not the same as self-serve Open. |
| **Diverg Auto** | OpenClaw integration: natural-language agent commands that drive Diverg Open (scans, investigations, reports) without custom API glue. |
...
This repository powers the Diverg Open console stack and shared skills; it is not the full private delivery surface.
