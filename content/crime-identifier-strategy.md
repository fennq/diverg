# Diverg as #1 Crime Identifier — Strategy vs ZachXBT

How we beat manual investigators (ZachXBT, TRM, Arkham users) on **speed**, **scale**, and **actionable output**.

---

## How ZachXBT (and peers) work today
...
| Dimension | ZachXBT / manual | Diverg |
|-----------|-------------------|--------|
...
## Roadmap: better results than ZachXBT
...
Token metadata → website/social links → WHOIS, same IP, same server. Optional: Telegram/Discord scrape for “dev” wallet mentions. Complements on-chain with off-chain like ZachXBT does manually.
...
- **“Faster than a human thread”** — Same intel ZachXBT assembles by hand, in one run, with evidence hashes.
